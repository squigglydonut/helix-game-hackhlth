...
LoadingState.preload = function () {
    ...
    this.game.load.image('episodic-background', 'images/episodicmemmusic/background.png');
    ...
    this.game.load.spritesheet('warrior-hero', 'images/warrior-hero.png', 36, 42);
    ...
    this.game.load.audio('bgm', ['audio/Juhani Junkala [Retro Game Music Pack] Level 3.wav', 'audio/Juhani Junkala [Retro Game Music Pack] Title Screen.wav']);
};
